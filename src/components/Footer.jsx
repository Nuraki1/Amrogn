...
const Footer = () => {
  return (
    <>
<footer id="footer" className="poppins-regular bg-white dark:bg-gray-800">
...
ቃሊቲ */}
              ...
              <div>
                  <h2 className="mb-6 text-sm font-bold text-gray-900  dark:text-white">Contacts - ስልክ</h2>
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="https://x.com/nuraki23" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
              ...
              <a href="https://github.com/Nuraki1" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
